...
class SkipGANomaly(BaseModel):
    ...
    def build_model(self):
        ...
        with tf.name_scope("Testing"):
            ...
            rec = tf.reshape(self.image_input,[-1,25,1]) - tf.reshape(self.img_rec_ema,[-1,25,1])
        ...
        if self.config.log.enable_summary:
            with tf.name_scope("summary"):
                ...
                with tf.name_scope("image_summary"):
                    ...
                    tf.summary.image("reconstruct", self.img_rec_ema, 3, ["image_2"])
                    tf.summary.image("input_images", self.image_input, 3, ["image_2"])
        ...
        with tf.variable_scope("Generator", custom_getter=getter, reuse=tf.AUTO_REUSE):
            ...
            with tf.variable_scope("Encoder"):
                ...
                with tf.variable_scope(net_name):
                    ...
                    # Current layer is  Batch_size x 4 x 4 x 64
                net_name = "Layer_2"
                with tf.variable_scope(net_name):
                    ...
                    # Current layer is  Batch_size x 3 x 3 x 128
                net_name = "Layer_3"
                with tf.variable_scope(net_name):
                    ...
                    # Current layer is  Batch_size x 2 x 2 x 256
                net_name = "Layer_4"
                with tf.variable_scope(net_name):
                    ...
                    # Current layer is  Batch_size x 1 x 1 x 256
            # Decoder Part
            with tf.variable_scope("Decoder"):
                ...
                with tf.variable_scope(net_name):
                    ...
                    dec_layer_2 = tf.nn.relu(dec_layer_2, name="dec_relu1") # 2 2 128
                    dec_layer_2 = tf.concat([enc_layer_2, dec_layer_2], axis=-1)

                    # Current layer is Batch_size x 3 x 3 x 256
                net_name = "Layer_3"
                with tf.variable_scope(net_name):
                    ...
                    # Current layer is Batch_size x 4 x 4 x 128
                net_name = "Layer_4"
                with tf.variable_scope(net_name):
                    ...
                    # Current layer is Batch_size x 5 x 5 x 1
        return dec_layer_4
